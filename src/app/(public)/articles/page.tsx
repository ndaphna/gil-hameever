...
const articles: Article[] = [
  ...
  },
  {
    ...
    title: 'לילה טוב (באמת!): מדריך השורדת לשינה בגיל המעבר',
    url: '/good-sleep-menopause',
    teaser: 'את לא צריכה עוד כוס קפה. את צריכה להבין מה גיל המעבר מעולל לשינה שלך – ולמה גם 8 שעות כבר לא מספיקות. גם את מתהפכת במיטה בלילה כמו שניצל על מחבת? צללתי לעומק כדי להבין למה זה קורה לנו ואיך חוזרים לישון...',
