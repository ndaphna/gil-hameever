...
export default function SecretReportAccessPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const response = await fetch('/api/secret-report-access', {
        method: 'POST',
        headers: {
      ...
      // Redirect to secret report page after successful signup
      window.location.href = 'https://www.gilhameever.com/secret-report';
    } catch (err: any) {
      ...
      <div className="secret-report-access-container">
        ...
        <form onSubmit={handleSubmit} className="secret-report-access-form">
          ...
          <button
            ...
            disabled={isSubmitting}
          >
            {isSubmitting ? 'שולח...' : 'תני לי גישה לדו"ח'}
          </button>
        </form>
