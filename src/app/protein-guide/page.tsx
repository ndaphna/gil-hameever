...
const meals = [
  ...
  },
  {
    time: 'צהריים (33 גרם)',
    options: [
      'אפשרות א: 150 גרם עוף + גבינה קטנה = 50 גרם (פה אפשר לעשות buffer)',
      ...
      <div className="pgvc-wrapper">
        ...
        <article className="pgvc-card">
          ...
          <div className="pgvc-card-body">
            ...
            <p className="pgvc-step-sub-text">
              <strong>הפתרון לכל שלוש:</strong> אחרי שבוע של מעקב פשוט ביומן, גיליתי את הפערים שלי.
        ...
        <div className="pgvc-closing">
          ...
          <p className="pgvc-closing-text">
            <strong>את גוף שמשתנה, ולא גוף ששובר.</strong> ואת מחליטה לדאוג לו.
          </p>
