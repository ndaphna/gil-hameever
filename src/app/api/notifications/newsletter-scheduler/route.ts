...
export async function GET(request: Request) {
  try {
    ...
    console.log('🔐 Newsletter scheduler authentication check:', {
    ...
    if (cronSecret) {
      ...
      if (!isVercelCron && !isAuthorized) {
        console.error('❌ Unauthorized newsletter scheduler request:', {
          hasVercelHeader: !!vercelCronHeader,
          hasAuthHeader: !!authHeader,
          vercelCronValue: vercelCronHeader,
      ...
      console.log('✅ Newsletter scheduler request authorized');
    } else {
