...
/**
 * API endpoint for emergency map access signup
 * Adds contact to Brevo list #12 (Inspiration Waves / גלי השראה)
 */
export async function POST(request: NextRequest) {
  console.log('\n' + '='.repeat(60));
  console.log('📥 API: /api/emergency-map-access called');
  ...
  try {
    ...
    console.log('✅ Emergency map access signup complete!');
    console.log('='.repeat(60) + '\n');
    ...
    console.error('❌ Fatal error in emergency map access signup:', error);
