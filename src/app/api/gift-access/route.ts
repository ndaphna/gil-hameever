...
/**
 * API endpoint for gift access signup
 * Adds contact to Brevo list #12 (Inspiration Waves / גלי השראה)
 */
export async function POST(request: NextRequest) {
  console.log('\n' + '='.repeat(60));
  console.log('📥 API: /api/gift-access called');
  ...
  try {
    ...
    console.log('✅ Gift access signup complete!');
    console.log('='.repeat(60) + '\n');
    ...
    console.error('❌ Fatal error in gift access signup:', error);
