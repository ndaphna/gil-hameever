...
/**
 * API endpoint for brain fog access signup
 * Adds contact to Brevo list #12 (Inspiration Waves / גלי השראה)
 */
export async function POST(request: NextRequest) {
  console.log('\n' + '='.repeat(60));
  console.log('📥 API: /api/brain-fog-access called');
  ...
  try {
    ...
    console.log('✅ Brain fog access signup complete!');
    console.log('='.repeat(60) + '\n');
    ...
    console.error('❌ Fatal error in brain fog access signup:', error);
