...
export default function GoodSleepAccessPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const response = await fetch('/api/good-sleep-access', {
        method: 'POST',
        headers: {
      ...
      // Redirect to good sleep guide page after successful signup
      window.location.href = 'https://www.gilhameever.com/good-sleep-menopause';
    } catch (err: any) {
      ...
      <div className="good-sleep-access-container">
        ...
        <form onSubmit={handleSubmit} className="good-sleep-access-form">
          ...
          <button
            ...
            disabled={isSubmitting}
          >
            {isSubmitting ? 'שולח...' : 'שלחו לי את המדריך לשינה'}
          </button>
        </form>
