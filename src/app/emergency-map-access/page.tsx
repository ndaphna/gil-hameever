...
export default function EmergencyMapAccessPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const response = await fetch('/api/emergency-map-access', {
        method: 'POST',
        headers: {
      ...
      // Redirect to full roadmap page after successful signup
      router.push('/menopause-roadmap');
    } catch (err: any) {
      ...
      <div className="emergency-map-access-container">
        ...
        <form onSubmit={handleSubmit} className="emergency-map-access-form">
          ...
          <button
            ...
            disabled={isSubmitting}
          >
            {isSubmitting ? 'שולח...' : 'שלחי לי את המפה עכשיו'}
          </button>
        </form>
